...
//               bottomRight: Radius.circular(0), // Square bottom-right corner
//             ),
//           ),
//           child: ClipRRect(
//             borderRadius: BorderRadius.only(
...
//                         Colors.black12.withOpacity(0.75), // Edge color (black with 75% opacity)
//                       ],
//                       stops: [0.0, 1.0],
...
//                       stops: [0.0, 0.5], // Gradient starts at the bottom and transitions to the top
//                     ),
//                   ),
//                 ),
//                 Align(
...
//                     // color: Colors.black.withOpacity(0.5), // Optional: background color for better text visibility
//                     child: Text(
//                       title1,
...
//                       colors: [
//                         Colors.transparent, // Center color (transparent)
//                         Colors.black.withOpacity(0.75), // Edge color (black with 75% opacity)
//                       ],
//                       stops: [0.0, 1.0],
//                       center: Alignment.center,
//                       radius: 0.7,
