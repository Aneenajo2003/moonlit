        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: Icon(Icons.menu_rounded,
                size: 35.sp, color: appcolor), // ScreenUtil applied here
            title: Image.asset(
              "assets/images/img.png",
              color: appcolor,
              height: 25.h, // ScreenUtil applied here
              width: 125.w, // ScreenUtil applied here
            ),
            actions: [
              badges.Badge(
                badgeStyle: badges.BadgeStyle(
                  badgeColor: Colors.red,
                  padding: EdgeInsets.all(4.w), // ScreenUtil applied here
                  borderRadius:
                      BorderRadius.circular(8.r), // ScreenUtil applied here
                  elevation: 1,
                ),
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  height: 150.h,
                  //width: 420.w,// ScreenUtil applied here
                  child: Center(
                    child: CarouselSlider.builder(
                      ...
                      options: CarouselOptions(
                        height: 150.h, // ScreenUtil applied here
                        viewportFraction: 1,
                        initialPage: 0,
                ...
                SizedBox(
                  height: 10.h, // ScreenUtil applied here
                  child: Center(
